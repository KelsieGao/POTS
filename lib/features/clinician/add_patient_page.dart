...
class _AddPatientPageState extends State<AddPatientPage> {
  ...
  Future<void> _onSubmit() async {
    ...
    try {
      await ClinicianService.addPatientToClinician(
  ...
  Widget _buildKeypadButton(String label) {
    ...
    return Material(
      color: isSpecial ? Colors.grey.shade200 : const Color(0xFF20B2AA),
    ...
    return Column(
      children: [
        TextButton.icon(
          ...
          label: const Text(
            'Where do patients find their code?',
        ...
        if (_showHelp) ...[
          ...
          Container(
            ...
            child: const Text(
              'Patient codes are generated when they create their profile '
              'in the app. They can find it in their patient settings or '
              'on the main screen of the patient app.',
              style: TextStyle(
                color: Colors.white,
                fontSize: 14,
              ),
